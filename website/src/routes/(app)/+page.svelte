        ...
        <div class="selector">
          ...
          <button
            ...
            on:click={async () => {
              ...
              const { x, y } = placeCanvas.getCanvasCoordsFromScreenCoords(
                cursorBounds.left,
                cursorBounds.top,
              );
            ...
            style="
              ...
              100}%, #FF000050 {(1 - cooldown / PlaceCanvas.COOLDOWN) *
              100}%, #FF000050 99%);
                    "
          >
            <Brush
...
<Modal bind:this={rulesModal}>
  <div class="container mx-auto">
    {#if countdown >= 0}
      ...
      <p>
        Pour pouvoir participer, tu dois prendre en compte ces quelques règles:
      </p>
      <ul class="list-decimal ml-4">
        <li>Chaque pixel placé te donne un point au Leaderboard.</li>
        <li>
          Tu n'as pas le droit de dessiner des choses offensives ou obscènes.
        </li>
        <li>
        ...
        <li>
          La Liste Kraken se réserve le droit de restreindre l'accès au site et
          de signaler les comptes ne respectant pas les règles énoncés
          ci-dessus.
        </li>
        <li>
          La Liste Kraken décline toute responsabilité concernant le contenu
          présent sur cet espace. Toute personne participante s'engage en tant
          qu'individu et non au nom de quelquonque entite ou organisation.
        </li>
      </ul>
      ...
      <ul class="list-decimal ml-4">
        ...
        <li>
          Tu peux séléctionner un pixel sur le canvas en maintenant le clic
          gauche et en bougeant ta souris.
        </li>
        <li>
          Choisis une couleur dans la palette et clique sur le pinceau pour
          dessiner.
        </li>
        <li>
          Tu peux aussi cliquer sur une case pour voir qui l'a modifé et quand.
        </li>
        <li>
          Si tu rencontre des problèmes, assure toi d'etre sur un pc/laptop avec
          chrome.
        </li>
      </ul>
      <button
