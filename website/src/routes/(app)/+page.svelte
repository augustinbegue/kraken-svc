        ...
        <div class="">
            ...
            >
                <a
                    href=""
                    target="_blank"
                    class="btn btn-primary btn-outline rounded-full h-14 w-14"
                >
                    <Instagram />
                </a>
                <a
                    href=""
                    target="_blank"
                    class="btn btn-accent btn-outline rounded-full h-14 w-14"
                >
                    <svg
                        class="mt-1 fill-accent hover:fill-accent-content"
                        viewBox="0 0 71 80"
                ...
                <a
                    href=""
                    target="_blank"
                    class="btn btn-secondary btn-outline rounded-full h-14 w-14"
                >
                    <Twitch />
                </a>
            </div>
...
>
        ...
        <div class="card shadow-xl bg-base-100">
            <div class="card-body">
                <div class="flex flex-col">
                    ...
                    {/each}
                    <a href="/leaderboard" class="underline">Full Leaderboard</a
                    >
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-col gap-4">
            ...
            <div class="card-body">
                {#if data.profile}
                    ...
                    <div class="card-actions">
                        <a class="btn btn-error btn-sm" href="/accounts/logout">
                            Logout
                        </a>
                    </div>
                {:else}
        ...
        <div
            class="card zshadow-xl bg-base-100 cursor-pointer"
            on:click={(e) => {
                e.preventDefault();
                goto("/place");
            }}
